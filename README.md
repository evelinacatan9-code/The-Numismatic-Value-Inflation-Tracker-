...
An Independent Quantitative Data Project built in Python

## 1. Objective
What problem does this program solve ? 
My project solves the problem of distorting historical currency values by stripping away centuries of inflation to reveal what ancient or obsolete money could actually purchase. By anchoring historical data to real-time precious metal assets and cross-era commodity baskets, it provides an objective, multi-dimensional framework for comparing economic purchasing power across human history. 

## 2. Theoretical Framework (The Core Economic Lenses)
## Theoretical Framework: The Three Economic Lenses
